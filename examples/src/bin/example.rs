...
use rusty_p4::app::linkprobe::{LinkProbeInterceptor, LinkProbeLoader};
use rusty_p4::app::proxyarp::{ArpInterceptor, ProxyArpLoader};
...
pub async fn main() {
    ...
    let (mut context, driver) =
        Context::try_new(pipeconfs, app, Some(restore), ContextConfig::default())
            .await
            .unwrap();
